...
import { ApiGatewayPresenter } from '../presenters/apiGateway/apiGatewayPresenter';
...
import { InternalServerException } from '../exceptions/presentation';

export const basicApiGatewayHandler =
  <T>(parseBody: BodyParserInterface<T>, useCase: UseCaseInterface<T>, em: ExceptionsMatcherInterface = exceptionsMatcher): APIGatewayProxyHandler =>
